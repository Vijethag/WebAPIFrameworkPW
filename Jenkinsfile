    ...
    stages {
        ...
        stage('Build & Unit Tests') {
            steps {
                ...
                echo "========================================="
                dir('dev-app') {
                    git url: 'https://github.com/Vijethag/simple-maven-project-with-tests.git',
                        branch: 'master'
        ...
        stage('Build Docker Image') {
            steps {
                ...
                echo "========================================="
                dir('qa-tests') {
                    git url: 'https://github.com/Vijethag/WebAPIFrameworkPW.git',
                        branch: 'main'
...
🔍 <${env.BUILD_URL}console|View Console Logs>
                ...
                // Email Notification
                emailext(
                    to: 'vijetha.gopisetty@gmail.com',
